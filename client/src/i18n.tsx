...
const pt = {
  ...
  leagues: {
    ...
    lead:
      "Monte o bolão com os amigos: crie uma liga, compartilhe o código e disputem a maior sequência da Copa.",
    nicknameLabel: "Seu apelido",
    nicknamePlaceholder: "ex.: rafa.sol",
    createTitle: "🏟️ Criar uma liga",
    nameLabel: "Nome da liga",
    namePlaceholder: "ex.: Resenha da Copa",
    createBtn: "Criar liga grátis",
    joinTitle: "🎟️ Entrar com código",
    codeLabel: "Código da liga",
    codePlaceholder: "ex.: K7M2QX",
    joinBtn: "Entrar na liga",
    working: "Enviando…",
    yourLeague: "Sua liga",
    codeShare: "Código para convidar",
    copyCode: "Copiar código",
    copied: "✓ Copiado!",
    members: (n: number, limit: number) => `${n}/${limit} membros`,
    tablePlayer: "Jogador",
    tableStreak: "Melhor sequência",
    you: "você",
    refresh: "↻ Atualizar",
    leave: "Sair da liga",
    freeTag: "Grátis",
    premiumTag: "⭐ Premium",
    upsellTitle: "⭐ Upgrade Premium",
    upsellItems: [
      "Até 100 membros (grátis: 10)",
      "Emblema personalizado da liga",
      "Apoia o projeto — pagamento verificado on-chain",
    ],
    price: (sol: number, network: string) => `${sol} SOL · ${network}`,
    payStep1: "1. Envie o valor para a carteira do Hi-Lo:",
    payStep2: "2. Cole a assinatura da transação para confirmar:",
    txSigLabel: "Assinatura da transação",
    txSigPlaceholder: "cole o txSig aqui",
    emojiLabel: "Emblema (emoji, opcional)",
    upgradeBtn: "Verificar pagamento e ativar",
    upgradeOk: "🎉 Liga premium ativada!",
  ...
  profile: {
    title: "Seu perfil",
    lead:
      "Progressão local, sem cadastro: jogue para ganhar XP, subir de nível e desbloquear conquistas.",
    levelNames: {
      bronze: "Bronze",
      silver: "Prata",
      gold: "Ouro",
    ...
    xp: "XP",
    nextLevel: (name: string, xp: number) => `faltam ${xp} XP para ${name}`,
    maxLevel: "nível máximo alcançado",
    statGames: "Partidas",
    statGuesses: "Palpites certos",
    statAccuracy: "Taxa de acerto",
    statBest: "Melhor sequência",
    statFav: "Categoria favorita",
    none: "—",
    missionsTitle: "🎯 Missões",
    badgeNames: {
      "first-correct": {
        name: "Primeiro acerto",
        desc: "Acerte seu primeiro palpite",
      },
      "streak-5": { name: "Esquentou", desc: "Faça 5 acertos seguidos" },
      "streak-10": { name: "Imparável", desc: "Faça 10 acertos seguidos" },
      "games-20": { name: "Maratonista", desc: "Jogue 20 partidas" },
      "guesses-100": { name: "Centurião", desc: "Acerte 100 palpites" },
      "all-cats": {
        name: "Mestre das categorias",
        desc: "Acerte em todas as 4 categorias",
      },
    } as Record<string, { name: string; desc: string }>,
    catBreakdown: "Acertos por categoria",
    playCta: "⚽ Jogar para ganhar XP",
    xpRules: "+10 XP por acerto · +2 por tentativa · +20 por partida concluída",
  },
...
const en: Dict = {
  ...
  leagues: {
    ...
    lead:
      "Set up a pool with friends: create a league, share the code and battle for the longest World Cup streak.",
    nicknameLabel: "Your nickname",
    nicknamePlaceholder: "e.g. rafa.sol",
    createTitle: "🏟️ Create a league",
    nameLabel: "League name",
    namePlaceholder: "e.g. World Cup Crew",
    createBtn: "Create free league",
    joinTitle: "🎟️ Join with a code",
    codeLabel: "League code",
    codePlaceholder: "e.g. K7M2QX",
    joinBtn: "Join league",
    working: "Sending…",
    yourLeague: "Your league",
    codeShare: "Invite code",
    copyCode: "Copy code",
    copied: "✓ Copied!",
    members: (n: number, limit: number) => `${n}/${limit} members`,
    tablePlayer: "Player",
    tableStreak: "Best streak",
    you: "you",
    refresh: "↻ Refresh",
    leave: "Leave league",
    freeTag: "Free",
    premiumTag: "⭐ Premium",
    upsellTitle: "⭐ Premium upgrade",
    upsellItems: [
      "Up to 100 members (free: 10)",
      "Custom league emblem",
      "Supports the project — payment verified on-chain",
    ],
    price: (sol: number, network: string) => `${sol} SOL · ${network}`,
    payStep1: "1. Send the amount to the Hi-Lo wallet:",
    payStep2: "2. Paste the transaction signature to confirm:",
    txSigLabel: "Transaction signature",
    txSigPlaceholder: "paste the txSig here",
    emojiLabel: "Emblem (emoji, optional)",
    upgradeBtn: "Verify payment & activate",
    upgradeOk: "🎉 Premium league activated!",
  ...
  profile: {
    title: "Your profile",
    lead:
      "Local progression, no sign-up: play to earn XP, level up and unlock achievements.",
    levelNames: {
      bronze: "Bronze",
      silver: "Silver",
      gold: "Gold",
    ...
    xp: "XP",
    nextLevel: (name: string, xp: number) => `${xp} XP to reach ${name}`,
    maxLevel: "max level reached",
    statGames: "Games",
    statGuesses: "Correct guesses",
    statAccuracy: "Accuracy",
    statBest: "Best streak",
    statFav: "Favorite category",
    none: "—",
    missionsTitle: "🎯 Missions",
    badgeNames: {
      "first-correct": {
        name: "First blood",
        desc: "Get your first guess right",
      },
      "streak-5": { name: "Heating up", desc: "Get 5 correct in a row" },
      "streak-10": { name: "Unstoppable", desc: "Get 10 correct in a row" },
      "games-20": { name: "Marathoner", desc: "Play 20 games" },
      "guesses-100": { name: "Centurion", desc: "Nail 100 guesses" },
      "all-cats": {
        name: "Category master",
        desc: "Score in all 4 categories",
      },
    },
    catBreakdown: "Correct guesses by category",
    playCta: "⚽ Play to earn XP",
    xpRules: "+10 XP per correct guess · +2 per try · +20 per finished game",
  },
